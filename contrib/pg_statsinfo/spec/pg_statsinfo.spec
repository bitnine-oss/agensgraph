...
%changelog
* Wed Feb  24 2016 - NTT OSS Center 3.1.2-1
...
- Fixed manual.
* Wed Oct   8 2015 - NTT OSS Center 3.1.1-1
- Fixed a bug that commit/rollback tps are reported in negative value.
- Fixed a TYPO of GUC (long_lock_threshold).
- Fixed a bug that the same lock conflict are reported duplicate.
- Fixed a bug that the lock conflict that occured in other than default database
  are not shown name of schema and table.
- Fixed manual.
