...
/* Edge Index */
DATA(insert ( 7121 7002 7002  1 s 7089 7120 0 ));
DATA(insert ( 7121 7002 7002  2 s 7091 7120 0 ));
DATA(insert ( 7121 7002 7002  3 s 7087 7120 0 ));
DATA(insert ( 7121 7002 7002  4 s 7092 7120 0 ));
DATA(insert ( 7121 7002 7002  5 s 7090 7120 0 ));
