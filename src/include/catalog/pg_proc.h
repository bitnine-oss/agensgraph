...
DATA(insert OID = 7122 (  edgeidxhandler	PGNSP PGUID 12 1 0 0 0 f f f f t f v s 1 0 325 "2281" _null_ _null_ _null_ _null_ _null_	edgeidxhandler _null_ _null_ _null_ ));
