...
DATA(insert OID = 7245 ( jsonb_graphid	PGNSP PGUID 12 1 0 0 0 f f f f t f i s 1 0 7002 "3802" _null_ _null_ _null_ _null_ _null_ jsonb_graphid _null_ _null_ _null_ ));
