...
/* used on agensgraph. */
#define raw_expression_tree_mutator(n, m, c) \
	raw_expression_tree_mutator_impl(n, (tree_mutator_callback) (m), c)
...
/* used on agensgraph. */
extern Node *raw_expression_tree_mutator_impl(Node *node,
											  tree_mutator_callback mutator,
											  void *context);
