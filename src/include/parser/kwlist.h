...
PG_KEYWORD("collect", COLLECT, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("count", COUNT, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("current_graph", CURRENT_GRAPH, RESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("current_property_graph", CURRENT_PROPERTY_GRAPH, RESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("finish", FINISH, RESERVED_KEYWORD, AS_LABEL)
...
PG_KEYWORD("insert", INSERT, RESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("let", LET, UNRESERVED_KEYWORD, AS_LABEL)
