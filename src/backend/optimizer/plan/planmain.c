			  ...
			  query_pathkeys_callback qp_callback, void *qp_extra)
{
	 ...
	 * Then prune vertex/edge scans that carry a constant id() filter down to
	 * the one label the graphid identifies (intersecting into the above);
	 * this one is structural and runs even when ag_graphmeta gathering is
	 * off.
	 */
