...
ExecInitMaterial(Material *node, EState *estate, int eflags)
{
	 ...
	 * child reports an empty planner targetlist (its real output shape lives
	 * in its subplan and is materialized at execution time), which would
	 * otherwise give this node a zero-attribute result descriptor and trip
	 * the slot-width assertion in ExecCopySlot() below.
	 */
