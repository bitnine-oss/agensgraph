...
/*
 *	_ei_doinsert() -- Handle insertion of a single index tuple in the tree.
 *
...
top:
	 ...
	 * (This requires some care in _ei_insertonpg.)
	 *
...
/*
 *	_ei_findinsertloc() -- Finds an insert location for a tuple
 *
 ...
 *		chosen insert location.  If _ei_findinsertloc decides to move right,
...
/*----------
 *	_ei_insertonpg() -- Insert a tuple on a particular page in the index.
 *
			   ...
			   bool split_only_page)
{
	...
	else
	{
		 ...
		 * metapage here --- see comments for _ei_newroot().
		 */
		if (split_only_page)
		{
...
/*
 * _ei_insert_parent() -- Insert downlink into parent after a page split.
 *
...
/*
 * _ei_finish_split() -- Finish an incomplete split
 *
 * A crash or other failure can leave a split incomplete.  The insertion
 * routines won't allow to insert on a page that is incompletely split.
 * Before inserting on such a page, call _ei_finish_split().
 *
...
/*
 *	_ei_getstackbuf() -- Walk back up the tree one step, and find the item
...
/*
 *	_ei_newroot() -- Create a new root page for the index.
 *
...
/*
 * _bt_isequal - used in _ei_doinsert in check for duplicates.
 *
