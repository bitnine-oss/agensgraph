/*-------------------------------------------------------------------------
 * edgeidx.c
 *	  Mimics nbtree/nbtree.c
 *
 * NOTES
 *	  The ei functions are little bit changed from bt functions.
 *	  Thus same bt functions and structure are redefined.
 *	  See details in README.
 *
 * Copyright (c) 2016 by Bitnine Global, Inc.
 *
 * IDENTIFICATION
 *	  src/backend/access/edgeidx/edgeidx.c
 *-------------------------------------------------------------------------
 */
#include "postgres.h"
